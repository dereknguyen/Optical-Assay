...
public:
    ...
    /*!
     Perform color analysis for detected wells.
    ...
    void calculateParams(double wellSpacing,
                               double wellRadius,
                               CircleSegment::HoughParameters *hp);
    
    vector<Vec3f> getCirclesPositionWithWellValues(Mat image,
                                                    string phoneModel,
